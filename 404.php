...
<body class="body">
	<div class="wrapper">
		<div class="container header__container">
			<header class="header">		
				<a href="https://ad-space.ru/index.html" ><img src="img/logo.svg" class="logo" alt=""></a>
				<nav class="nav">
					<ul>
		...
		<main class="main">
			<section>
				<div class="container">
					<div class="mistake">
						<h1 class="mistake__title">Ошибка!</h1>

						<img class="mistake__img" src="./img/404.png" alt="404">

						<p class="mistake__subtitle">
							Упс, кажестя пошло что-то не так! 
							Видимо, страницы, которую вы запрашиваете, не сущетсвует. 
							Возможно она устарела, была удалена, 
							или был введен неверный адрес в адресной строке.
						</p>

						<div class="mistake__btn btn-blue">
							<a href="https://ad-space.ru/index.html">перейти на главную</a>
						</div>
					</div>
				</div>
			</section>
