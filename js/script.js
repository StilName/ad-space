...
if(document.querySelector('.index')){
    const imgOfferDesk = document.querySelector('.offer-img-desktop');
    const videoOfferDesk = document.querySelector('.offer-video');
    ...
    videoOfferDesk.addEventListener("ended", function (){
        videoOfferDesk.style.display = 'none';
        videoOfferMobile.style.display = 'none';
        imgOfferDesk.style.display = 'block';
        videoOfferDesk.parentElement.style.opacity = '1';
        videoOfferDesk.parentElement.style.zIndex = '-2';
    });
    videoOfferMobile.addEventListener("ended", function (){
        videoOfferMobile.style.display = 'none';
        videoOfferDesk.style.display = 'none';
        imgOfferMob.style.display = 'block';
        videoOfferMobile.parentElement.style.opacity = '1';
        videoOfferMobile.parentElement.style.zIndex = '-2';
    });
